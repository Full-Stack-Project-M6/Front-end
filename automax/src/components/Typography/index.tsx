...
export const H3 = ({ children, weight = 600, ...rest }: IProps) => (
  <h3 className={weight === 500 ? "heading-3-500" : "heading-3-600"} {...rest}>
    {children}
  </h3>
);

export const H4 = ({ children, weight = 600, ...rest }: IProps) => (
  <h4 className={weight === 500 ? "heading-4-500" : "heading-4-600"} {...rest}>
    {children}
  </h4>
);

export const H5 = ({ children, weight = 600, ...rest }: IProps) => (
  <h5 className={weight === 500 ? "heading-5-500" : "heading-5-600"} {...rest}>
    {children}
  </h5>
);

export const H6 = ({ children, weight = 600, ...rest }: IProps) => (
  <h6 className={weight === 500 ? "heading-6-500" : "heading-6-600"} {...rest}>
    {children}
  </h6>
);

export const Body1 = ({ children, weight = 400, ...rest }: IProps) => (
  <p className={weight === 600 ? "body-1-600" : "body-1-400"} {...rest}>
    {children}
  </p>
);

export const Body2 = ({ children, weight = 400, ...rest }: IProps) => (
  <p className={weight === 500 ? "body-2-500" : "body-2-400"} {...rest}>
    {children}
  </p>
);
